...
gulp.task('concat:js', function() {
    return gulp.src(['src/scripts/vendor/jquery-2.2.4.min.js', 'src/scripts/vendor/bootstrap.min.js', 'src/scripts/vendor/moment.min.js', 'src/scripts/vendor/locales/zh-cn.js', 'src/scripts/vendor/**/*.js']).pipe(sourcemaps.init()).pipe(concat('bundle.min.js')).pipe(sourcemaps.write()).pipe(gulp.dest('dist/scripts'))
});
...
gulp.task('watch', ['browserSync:static', 'style:dev', 'pug:static'], function() {
